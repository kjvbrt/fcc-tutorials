...
We will generate a Monte Carlo sample of 1'000 events for $e^{+} e^{-} \;\rightarrow\; Z \;\rightarrow\; b\bar{b} \;\rightarrow\; B^{+} \;\rightarrow\; \tau^{+} \nu_{\tau} \;\rightarrow\; 3\pi$. All standard configuration files for FCC-ee Monte Carlo campaigns are provided in the [FCC-config repository (`pre_summer2026` branch)](https://github.com/HEP-FCC/FCC-config/tree/pre_summer2026).
...
```bash
wget https://raw.githubusercontent.com/HEP-FCC/FCC-config/pre_summer2026/FCCee/Generator/Pythia8/p8_ee_Zbb_ecm91_EvtGen_Bu2TauNuTAUHADNU.cmd
```
...
```bash
wget https://raw.githubusercontent.com/HEP-FCC/FCC-config/pre_summer2026/FCCee/Generator/EvtGen/DECAY.DEC
wget https://raw.githubusercontent.com/HEP-FCC/FCC-config/pre_summer2026/FCCee/Generator/EvtGen/evt.pdl
wget https://raw.githubusercontent.com/HEP-FCC/FCC-config/pre_summer2026/FCCee/Generator/EvtGen/Bu2TauNuTAUHADNU.dec
```
